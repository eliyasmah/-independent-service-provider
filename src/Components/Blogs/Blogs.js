        ...
        <div>
            <div className='m-10 md:m-20 '>
                <div className='bg-slate-200 p-5 rounded-lg mb-10 shadow-lg'>
                    ...
                    <p><span className='text-xl text-red-600'>Answer:</span> Authentication is a process of verifying who someone is,whereas authorization is a process of verifying what specific applications, files, and data a user has access to.
